        ...
        <Container className={"about"}>
          <Row>
            <Col lg={{span: 1, offset: 1}}>
              <b className={ "about__text-letter" }>
                Designtalk.ru
              </b>
            </Col>
            <Col lg={8}>
              <p>
                - это блог и онлайн-издание о дизайне пространств и всего что в этом пространстве находится.
                <br/>Мы стараемся в максимально доступной и удобной форме информировать своего читателя о самых последних
                новостях дизайна интерьеров, искусства, архитектуры, а также дизайна мебели и предметов декора. 
